...
const ContactPageClient = ({ lng, contactData }) => {
  ...
  const phone = contactData?.phone?.value || "+971509714136";
  const whatsapp = contactData?.whatsapp?.value || "+971509714136";
  const email = contactData?.email?.value || "alqobaalzahabia@gmail.com";
  const location = contactData?.location?.value || "Dubai, UAE";
  const locationDetails = contactData?.location_details?.value || "Horizon Building, Office 42";
  const mapUrl = contactData?.map_url?.value || "";
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="font-bold text-[#172436] text-lg sm:text-xl mb-3">
                    {contactData?.phone?.label?.[lng] || t('contactUs.contactWithPhone')}
                  </h3>
                ...
                <div>
                  <h3 className="font-bold text-[#172436] text-lg sm:text-xl mb-3">
                    {contactData?.whatsapp?.label?.[lng] || t('contactUs.contactWithWhatsApp')}
                  </h3>
                  <div className="flex items-center gap-3">
                    <svg
                ...
                <div>
                  <h3 className="font-bold text-[#172436] text-lg sm:text-xl mb-3">
                    {contactData?.email?.label?.[lng] || t('contactUs.contactWithEmail')}
                  </h3>
                  <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-[#172436] text-lg sm:text-xl mb-3">
                    {contactData?.location?.label?.[lng] || t('contactUs.ourLocation')}
                  </h3>
                  <div className="flex items-center gap-3">
                ...
                <div className="relative bg-white rounded-xl border border-solid border-[#e5e5e5] shadow-cards overflow-hidden h-[300px] sm:h-[350px] mt-8">
                  ...
                  <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm text-[#172436] px-3 py-2 rounded-lg shadow-md font-semibold text-sm">
                    {locationDetails.split(',').pop().trim()}
                  </div>
                </div>
              </div>
            </section>
