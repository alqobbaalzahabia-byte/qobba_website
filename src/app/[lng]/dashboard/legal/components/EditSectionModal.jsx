...
export default function EditSectionModal({ section, isOpen, onClose, onSave, lng, type }) {
  ...
  useEffect(() => {
    if (section && isOpen) {
      setValue('titleEn', section.title?.en || '')
      setValue('titleAr', section.title?.ar || '')
      
      const enContent = section.content?.en || ''
      const arContent = section.content?.ar || ''
      
      setContentEn(enContent)
      setContentAr(arContent)
      setValue('contentEn', enContent)
      setValue('contentAr', arContent)
    }
  }, [section, isOpen, setValue])
