        ...
        {loading ? (
          ...
          <div className="flex justify-center gap-6 lg:gap-11 flex-wrap sm:flex-nowrap">
            {plans.map((plan, planIndex) => {
              ...
              const isContactSales = plan.show_contact_sales || false;
                ...
                >
                  <Card className="lg:w-[363px] pb-3 px-2 mx-auto mt-2 rounded-[18px] bg-[linear-gradient(90deg,#FFF8EC_0%,#FFEDD1_100%)] border-0 shadow-none">
                    <div className="relative px-2">
                      ...
                      {isContactSales ? (
                        <div className="plan-price flex justify-center items-center py-6">
                          <div className="text-center">
                            <p className="font-bold text-[#f0a647] text-[32px] lg:text-[48px]">
                              {t('pricing.contactSales') || 'Contact Sales'}
                            </p>
                            <p className="text-[#878787] text-sm mt-2">
                              {t('pricing.customPricing') || 'Custom pricing for your needs'}
                            </p>
                          </div>
                        </div>
                      ) : (
                      ...
                      <Button
                        onClick={isContactSales ? handleContactSales : undefined}
                        className={`cursor-pointer w-full sm:w-[90%] md:w-full lg:w-[331px] rounded-[18px] h-auto transition-transform hover:scale-105 ${
